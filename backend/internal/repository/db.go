...
{"type":"function","function":{"name":"list_images","description":"列举所有可用镜像","parameters":{"type":"object","properties":{}}}}
			...
			},
			{
				...
				Type:        "cloud_api",
				Config:      `{"service":"storage","api_version":"v3"}`,
				ToolDefs: `[
{"type":"function","function":{"name":"list_volumes","description":"列举所有云硬盘及其详细信息。API: GET /v3/{project_id}/volumes/detail?all_tenants=1","parameters":{"type":"object","properties":{}}}},
{"type":"function","function":{"name":"list_volume_types","description":"查询云硬盘类型列表(如hdd/ssd)。API: GET /v3/{project_id}/types","parameters":{"type":"object","properties":{}}}},
{"type":"function","function":{"name":"create_volume","description":"创建一个新的云硬盘。API: POST /v3/{project_id}/volumes","parameters":{"type":"object","properties":{"name":{"type":"string","description":"云硬盘名称"},"size":{"type":"integer","description":"大小(GB)"},"volume_type":{"type":"string","description":"云硬盘类型(如hdd)，通过list_volume_types获取"},"description":{"type":"string","description":"云硬盘描述"},"imageRef":{"type":"string","description":"镜像ID(从镜像创建云硬盘时使用)"}},"required":["name","size","volume_type"]}}},
{"type":"function","function":{"name":"delete_volume","description":"删除云硬盘（危险操作）。API: DELETE /v3/{project_id}/volumes/{volume_id}","parameters":{"type":"object","properties":{"volume_id":{"type":"string","description":"云硬盘ID"}},"required":["volume_id"]}}},
{"type":"function","function":{"name":"extend_volume","description":"扩容云硬盘。API: POST /v3/{project_id}/volumes/{volume_id}/action","parameters":{"type":"object","properties":{"volume_id":{"type":"string","description":"云硬盘ID"},"new_size":{"type":"integer","description":"新大小(GB)"}},"required":["volume_id","new_size"]}}},
{"type":"function","function":{"name":"get_volume_detail","description":"查询指定云硬盘的详细信息(含存储后端、挂载信息)。API: GET /v3/{project_id}/volumes/{volume_id}","parameters":{"type":"object","properties":{"volume_id":{"type":"string","description":"云硬盘ID(可选，不传则返回全部)"}}}}},
...
{"type":"function","function":{"name":"list_volume_snapshots","description":"列举所有云硬盘快照。API: GET /v3/{project_id}/snapshots/detail","parameters":{"type":"object","properties":{}}}},
